				...
				each(newWrappers, function(node) {
					...
					if (format.inline || format.wrapper) {
						...
						each(formatList, function(format) {
							...
							// this: <span style="color:red"><b><span style="color:red; font-size:12px">text</span></b></span>
							// will become: <span style="color:red"><b><span style="font-size:12px">text</span></b></span>
